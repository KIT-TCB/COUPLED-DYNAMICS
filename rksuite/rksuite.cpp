...
//C
      ...
      if (goback) {
         intrp(twant,"Both solution and derivative",rkcom1.neqn,ygot,
            ypgot,f,work,&work[rkcom3.printp],rkcom3.lnintp, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
         chkfl(ask,baderr);
         if (baderr) goto label100;
         tgot = twant;
      }
...
//C
   rk_ct(f,tnow,ygot,ypgot,work,cflag, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
   ier = cflag;
//C
...
void rk_ut_tfs(void (*f)(double, double*, double*, int, double*, double**,double), double twant, double& tgot,
     ...
     int sites, double *energy, double **overlap, double dt)
{
   const char srname[] = "UT";
   const bool ask = true, tell = false;
   const int minus1 = -1, minus2 = -2;
   ...
   if (rkcom4.intp) {
      ...
      goback = rkcom1.dir*(rkcom2.t-twant) >= zero;
      if (goback) {
         intrp_tfs(twant,"Both solution and derivative",rkcom1.neqn,ygot,
            ypgot,f,work,&work[rkcom3.printp],rkcom3.lnintp, sites, energy, overlap, dt);
         chkfl(ask,baderr);
         if (baderr) goto label100;
         tgot = twant;
      }
   ...
   rk_ct_tfs(f,tnow,ygot,ypgot,work,cflag, sites, energy, overlap, dt);
   ier = cflag;
...
//C  and YPNOW(*).
      f(rkcom2.t,&work[rkcom3.pry],&work[rkcom3.pryp], sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
      rkcom2.nfcn++;
      for (l = 0; l < rkcom1.neqn; l++) {
...
//C  stiffness.
      stiff(f,havg,jflstp,toomch,maxfcn,work,ier,nrec, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
//C
...
//C
   ...
   step(f,rkcom1.neqn,rkcom2.t,&work[rkcom3.pry],&work[rkcom3.pryp],&work[rkcom3.prstgs],rkcom1.tolr,htry,
      ...
      &work[rkcom3.prthrs],phase2, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
   rkcom2.h = htry;
//C
...
//C
   if (rkcom6.erason) {
      truerr(f,rkcom1.neqn,&work[rkcom3.pry],rkcom1.tolr,&work[rkcom3.prwt],&work[rkcom6.przy],
         ...
         &work[rkcom6.przstg],ier, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
      if (ier == 6) {
//C
   ...
   double ypnow[], double work[],int& cflag, int sites, double *energy, double **overlap, double dt)
{
   ...
   if (rkcom2.first) {
      ...
      f(rkcom2.t,&work[rkcom3.pry],&work[rkcom3.pryp], sites, energy, overlap, dt);
      rkcom2.nfcn++;
      for (l = 0; l < rkcom1.neqn; l++) {
         ynow[l] = work[rkcom3.pry+l];
         ypnow[l] = work[rkcom3.pryp+l];
   ...
   if (!failed) {
      ...
      stiff_tfs(f,havg,jflstp,toomch,maxfcn,work,ier,nrec, sites, energy, overlap, dt);
   ...
   main = true;
   htry = rkcom2.h;
   step_tfs(f,rkcom1.neqn,rkcom2.t,&work[rkcom3.pry],&work[rkcom3.pryp],&work[rkcom3.prstgs],rkcom1.tolr,htry,
      &work[rkcom3.prwt],&work[ynew],&work[rkcom3.prerst],err,main,hmin,
      &work[rkcom3.prthrs],phase2, sites, energy, overlap, dt);
   rkcom2.h = htry;
   ...
   if (rkcom6.erason) {
      truerr_tfs(f,rkcom1.neqn,&work[rkcom3.pry],rkcom1.tolr,&work[rkcom3.prwt],&work[rkcom6.przy],
         &work[rkcom6.przyp],&work[rkcom6.przerr],&work[rkcom6.przynu],&work[rkcom6.przers],
         &work[rkcom6.przstg],ier, sites, energy, overlap, dt);
      if (ier == 6) {
...
void intrp(double twant, char reqest[], int nwant, double ywant[], double ypwant[],
   ...
   int lenint, int sites, double **hamiltonian, double **hubbard,
   int nip, int *site_nip, double nip_rate_constant)
{
//C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//C
...
//C
      if (rkcom4.methd == 1) {
         formi(f,rkcom1.neqn,nwant,&work[rkcom3.pry],&work[rkcom3.pryp],&work[rkcom3.pryold],
            ...
            &work[rkcom3.prstgs],&work[rkcom3.prstgs], sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
      }
      else {
         formi(f,rkcom1.neqn,nwant,&work[rkcom3.pry],&work[rkcom3.pryp],&work[rkcom3.pryold],
            &work[rkcom3.prscr],&work[rkcom3.prstgs],notinintp,wrkint,
            &wrkint[startp], sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
      }
//C
...
void intrp_tfs(double twant, char reqest[], int nwant, double ywant[], double ypwant[],
   ...
   int lenint, int sites, double *energy, double **overlap, double dt)
{
   ...
   if (!inintp || nwant != nwntsv) {
      ...
      if (rkcom4.methd == 1) {
         formi_tfs(f,rkcom1.neqn,nwant,&work[rkcom3.pry],&work[rkcom3.pryp],&work[rkcom3.pryold],
            &work[rkcom3.prscr],&work[rkcom3.prstgs],notinintp,
            &work[rkcom3.prstgs],&work[rkcom3.prstgs], sites, energy, overlap, dt);
      }
      else {
         formi_tfs(f,rkcom1.neqn,nwant,&work[rkcom3.pry],&work[rkcom3.pryp],&work[rkcom3.pryold],
            &work[rkcom3.prscr],&work[rkcom3.prstgs],notinintp,wrkint,
            &wrkint[startp], sites, energy, overlap, dt);
      }
         ...
         for (i = 9; i <= 11; i++) {
            ...
            if (i == 9) {
               f(rkcom2.told+rkcom4.c[i]*rkcom2.hold,p,
                  &stages/*[1][7]*/[neq*(7-1)], sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
               rkcom2.nfcn++;
            }
            else if (i == 10) {
               f(rkcom2.told+rkcom4.c[i]*rkcom2.hold,p,xstage, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
               rkcom2.nfcn++;
            }
            else {
               f(rkcom2.told+rkcom4.c[i]*rkcom2.hold,p,
                  &stages/*[1][1]*/[neq*(1-1)], sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
               rkcom2.nfcn++;
            }
         }
      }
   ...
   if (rkcom4.methd == 1) {
      ...
      if (calstg) {
         ...
         for (i = 9; i <= 11; i++) {
            ...
            if (i == 9) {
               f(rkcom2.told+rkcom4.c[i]*rkcom2.hold,p,
                  &stages/*[1][7]*/[neq*(7-1)], sites, energy, overlap, dt);
               rkcom2.nfcn++;
            }
            else if (i == 10) {
               f(rkcom2.told+rkcom4.c[i]*rkcom2.hold,p,xstage, sites, energy, overlap, dt);
               rkcom2.nfcn++;
            }
            else {
               f(rkcom2.told+rkcom4.c[i]*rkcom2.hold,p,
                  &stages/*[1][1]*/[neq*(1-1)], sites, energy, overlap, dt);
               rkcom2.nfcn++;
            }
         }
      }
...
//C  Take a step.
      step(f,neq,tsec,zy,zyp,zstage,ztest1,hsec,weight,zynew,
         zerres,zlerr,main,dummy,dumarr,ldummy, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
//C
...
//C  Call F to evaluate ZYP(*).
         f(tsec,zy,zyp, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
         rkcom6.gnfcn++;
      }
//C
   }
   ...
   double zynew[], double zerres[], double zstage /* [neq][] */ [], int& ier, int sites, double *energy, double **overlap, double dt)
{
   ...
   for (istep = 1; istep <= rkcom5.nsec; istep++) {
      ...
      step_tfs(f,neq,tsec,zy,zyp,zstage,ztest1,hsec,weight,zynew,
         zerres,zlerr,main,dummy,dumarr,ldummy, sites, energy, overlap, dt);
      ...
      if (rkcom5.fsal) {
         ...
         f(tsec,zy,zyp, sites, energy, overlap, dt);
         rkcom6.gnfcn++;
      }
...
//C
      ...
      f(tstg,ynew,/* stages[1][rkcom4.ptr[i]] */ &stages[neq*(rkcom4.ptr[i]-1)], sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
//C
   ...
   double hmin, double* thres, bool& phase2, int sites, double *energy, double **overlap, double dt)
{
   ...
   for (i = 2; i <= rkcom4.nstage; i++) {
      ...
      tstg = tnow + rkcom4.c[i]*htry;
      if (main && rkcom2.last && rkcom4.c[i] == one) tstg = rkcom1.tnd;
      f(tstg,ynew,/* stages[1][rkcom4.ptr[i]] */ &stages[neq*(rkcom4.ptr[i]-1)], sites, energy, overlap, dt);
...
//C
      stiffa(f,rkcom2.t,&work[rkcom3.pry],rkcom2.h,havg,rkcom1.tnd,maxfcn,&work[rkcom3.prwt],
         ...
         &work[rkcom3.prscr], sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
      if (!unsure) {
         if (stif) {
//C
...
//C
   ...
   label60:
//C
   stiffd(v0,havg,x,y,f,fxy,wt,scale,v0v0,v1,v1v1,vtemp, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
//C
...
//C
   ...
   stiffd(v1,havg,x,y,f,fxy,wt,scale,v1v1,v2,v2v2,vtemp, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
...
//C  of eigenvalues.
//C
   stiffd(v2,havg,x,y,f,fxy,wt,scale,v2v2,v3,v3v3,vtemp, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
   ...
   bool toomch, int maxfcn, double work[], int& ier, int& nrec, int sites, double *energy, double **overlap, double dt)
{
   ...
   if (toomch || lotsfl) {
      ...
      stiffa_tfs(f,rkcom2.t,&work[rkcom3.pry],rkcom2.h,havg,rkcom1.tnd,maxfcn,&work[rkcom3.prwt],
         &work[rkcom3.pryp],&work[rkcom3.prerst],unsure,stif,&work[rkcom3.prstgs],
         &work[rkcom3.prstgs+rkcom1.neqn],&work[rkcom3.prstgs+2*rkcom1.neqn],
         &work[rkcom3.prscr], sites, energy, overlap, dt);
      if (!unsure) {
         if (stif) {
   ...
   double v2[], double v3[], double vtemp[], int sites, double *energy, double **overlap, double dt)
{
   ...
   stiffd_tfs(v0,havg,x,y,f,fxy,wt,scale,v0v0,v1,v1v1,vtemp, sites, energy, overlap, dt);
   ...
   stiffd_tfs(v1,havg,x,y,f,fxy,wt,scale,v1v1,v2,v2v2,vtemp, sites, energy, overlap, dt);
   v0v2 = dotprd(v0,v2,wt,rkcom1.neqn);
   v1v2 = dotprd(v1,v2,wt,rkcom1.neqn);
   stiffb(v2v2,v1v2,v1v1,rold,rho,root1,root2,rootre);
   if (rootre) goto label100;
   ...
   stiffd_tfs(v2,havg,x,y,f,fxy,wt,scale,v2v2,v3,v3v3,vtemp, sites, energy, overlap, dt);
   v1v3 = dotprd(v1,v3,wt,rkcom1.neqn);
   v2v3 = dotprd(v2,v3,wt,rkcom1.neqn);
   stiffb(v3v3,v2v3,v2v2,rold,rho,root1,root2,rootre);
   if (rootre) goto label100;
...
//C
   f(x,vtemp,z, sites, hamiltonian, hubbard, nip, site_nip, nip_rate_constant);
   rkcom2.nfcn++;
//C
   ...
   double scale, double vdotv, double z[], double& zdotz, double vtemp[], int sites, double *energy, double **overlap, double dt)
{
   ...
   f(x,vtemp,z, sites, energy, overlap, dt);
   rkcom2.nfcn++;

...
/* TOMAS KUBAR slightly modified */
static gmx_bool do_numbering_tomas(int natoms, gmx_groups_t *groups, int ng, char *ptrs[],
                             t_blocka *block, char *gnames[],
                             int gtype, int restnm,
                             int grptp, gmx_bool bVerbose,
                             warninp_t wi)
              ...
              warninp_t wi)
{
    ...
    bRest           = /* TOMAS KUBAR */
        do_numbering_tomas(natoms, groups, nvcm, ptr1, grps, gnames, egcVCM,
